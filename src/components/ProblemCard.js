...
export default function CompetitionCard({ competitionId, problemId, problemAuthor, problemName, problemPreview }) {
  return (
    <Card className="m-2 border-primary">
      <Card.Body>
        ...
        <Button variant="primary" href={"/competitions/" + competitionId + '/' + problemId}>Learn More</Button>
      </Card.Body>
